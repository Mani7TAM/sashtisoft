...
export const metadata: Metadata = {
  title: "Sign Up Page | Free Next.js Template for Sashtisoft and SaaS",
  description: "This is Sign Up Page for Sashtisoft Nextjs Template",
  // other metadata
};
